...
class Ion_auth_model extends CI_Model
{
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login, subscribe, share_50, is_social_from')
		                  ->where($this->identity_column, $identity)
		                  ->limit(1)
		                  ->get($this->tables['users']);
	...
	**/
	...
	public function set_session($user)
	{
      ...
      'user_share_50'        => $user->share_50,
      'user_is_social_from'  => $user->is_social_from
		);
	...
	public function login_remembered_user()
	{
		...
		//get the user
		$this->trigger_events('extra_where');
		$query = $this->db->select($this->identity_column.', id, username, email, last_login, subscribe, share_50, is_social_from')
