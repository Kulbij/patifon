...
$lang['login_unsuccessful_not_active']          = 'Действие вашего аккаунта была временно приостановлено. Для подробной информации Вы можете отправить запрос по форме обратной связи.';
