...
class Send_lib {
    ...
    public function send_feedback($array) {
        ...
        $message = "
          Зворотній зв'язок від <b>" . date('d.m.Y H:i:s', strtotime($array['date'])) . "</b><br />
          <b>Ім'я:</b>&nbsp;{$array['name']}<br />
          <b>Пошта:</b>&nbsp;{$array['email']}<br />
          <b>Текст повідомлення:</b>&nbsp;{$array['text']}<br />
          <b>Посилання на сторінку:</b>&nbsp;<a href='{$array['link']}'>{$array['link']}</a><br />
          ---------------------------------------------------------<br />
