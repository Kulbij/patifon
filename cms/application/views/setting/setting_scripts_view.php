...
<div class="page-list">
  ...
  <div class="clear"></div>
  <div class="add"><img src="<?php echo base_url(); ?>images/plus.png" alt="#" /><a href="<?php echo base_url(), 'edit/', $MODULE, '/', $SUBMODULE; ?>">Додати сценарій</a></div>
  <div class="clear"></div>
  ...
  <ul>
   <?php foreach ($content['data'] as $one) : ?>
    <li class="item">
      ...
      ?>"><?php echo '№', $one['id']; ?></a></span></div>

        <div class="right-item">
            
            <span class="vertical"><a title="видалити" href="javascript:void(0);" onclick="if (confirm('Видалити сценарій?')) { window.location = <?php echo "'", base_url(), 'edit/del/setting_scripts/', $one['id'], "'"; ?>; } return false;"><img src="<?php echo base_url(); ?>images/del.png" alt="x" /></a></span>
