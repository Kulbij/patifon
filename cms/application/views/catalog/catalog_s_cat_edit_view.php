...
<div class="creation_page">
  ...
  <div>Ключ:</div>
   <input type="text" name="key" maxlength="10" value="<?php if (isset($content['key'])) echo $content['key']; ?>" />
   </div>
  ...
  <div class="small-field">
      <div style="color: red; font-weight: bold;">Картинка 240 x 148</div>
  ...
  <?php foreach ($this->config->item('config_languages') as $value) : ?>
   ...
   <h2>Короткий текст (<?php echo ltrim($value, '_'); ?>):</h2>
