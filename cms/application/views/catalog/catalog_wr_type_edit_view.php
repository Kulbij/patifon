...
<div class="creation_page">
  ...
  <div class="small-field">
      <div style="color: red; font-weight: bold;">Картинка 150 x 150</div>
  ...
  <div class="small-field">
   <div>Скільки елементів фасаду можна вибрати:</div>
   <input type="text" name="fasade_count" maxlength="1" value="<?php if (isset($content['fasade_count'])) echo $content['fasade_count']; else echo 1; ?>" />
  </div><div class="clear"></div>
  
  <div class="small-field">
   <div>Скільки дзеркал можна вибрати:</div>
   <input type="text" name="mirror_count" maxlength="1" value="<?php if (isset($content['mirror_count'])) echo $content['mirror_count']; else echo 1; ?>" />
  </div><div class="clear"></div>
