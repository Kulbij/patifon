  ...
  <ul>
   <?php $i = 0; $count_dd = count($content['data']); foreach ($content['data'] as $one) : ?>
    <li class="item">
      ...
      <div class="center-item" style="word-wrap: break-word; width: 320px;"><span class="vertical"><a href="<?php 
      echo base_url(), 'edit/', $MODULE, '/', $SUBMODULE, '/', $one['id']; 
      ?>"><?php echo $one['name']; if (isset($one['region_name']) && !empty($one['region_name'])) echo '&nbsp;&nbsp;&nbsp;(', $one['region_name'], ' обл.)'; ?></a></span></div>
