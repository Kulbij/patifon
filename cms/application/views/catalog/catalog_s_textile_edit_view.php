...
<div class="creation_page">
  ...
  <div class="small-field">
   ...
   <select name="region_id">
    <?php foreach ($CATS as $one) : ?>
     <option value="<?php echo $one['id']; ?>" <?php if (isset($content['region_id']) && $content['region_id'] == $one['id']) echo 'selected'; ?>><?php echo $one['name']; ?></option>
    <?php endforeach; ?>
   </select>
   </div>
   <div class="clear"></div>
  ...
  <div class="small-field">
      <div style="color: red; font-weight: bold;">Картинка 220 x 320</div>
