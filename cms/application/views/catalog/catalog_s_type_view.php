  ...
  <ul>
   <?php $i = 0; $count_dd = count($content['data']); foreach ($content['data'] as $one) : ?>
    <li class="item">
      ...
      <div class="center-item" style="width: 361px;"><span class="vertical"><a href="<?php 
      echo base_url(), 'edit/', $MODULE, '/', $SUBMODULE, '/', $one['id']; 
      ?>"><?php echo '«', $one['name'], '» от ', date('d.m.Y', strtotime($one['date_start'])), ' до ', date('d.m.Y', strtotime($one['date_end'])); ?></a></span></div>
