...
<div class="creation_page">
  <form id="saveform" action="<?php echo base_url().'edit/save/share'; ?>" method="post"  enctype="multipart/form-data">
...
<script type="text/javascript" language="JavaScript" src="<?php echo base_url(), 'js/datepicker.js'; ?>"></script>
  ...
  <div class="small-field">
    <div>Дата:</div>
    <input id="datepicker" type="text" style="margin-bottom: 3px;" name="date" readonly="readonly" maxlength="255" value="<?php if (isset($content['date'])) {
