...
<div class="catalog-list">
  ...
  <div class="clear"></div>
    <div class="add"><span>Кількість статей: <span class="big"><?php echo $COUNTPRO; ?></span></span><img src="<?php echo base_url(); ?>images/plus.png" alt="#" /><a href="<?php echo base_url(), 'edit/page/artical'; ?>">Додати статтю</a></div>
   ...
   <?php foreach ($content['data'] as $one) : ?>
    ...
    <li class="item">
      ...
      <div class="right-item">
        ...
        <span class="vertical"><a title="подивитись на сайті" href="<?php echo getsite_url(), 'articles/detail/', $one['link'], '.html'; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/zoom.png" alt="#" /></a></span>
        <?php endif; ?>

        <span class="vertical"><a href="javascript:void(0);"
        <?php if (isset($one['visible']) && $one['visible'] == 1) : ?>
          title="зробити невидимою" onclick="window.location = <?php echo "'", base_url(), 'edit/unvis/artical/', $one['id'], "'"; ?>; return false;"><img src="<?php echo base_url(), 'images/eye.png'; ?>"
        <?php else : ?>
          title="зробити видимою" onclick="window.location = <?php echo "'", base_url(), 'edit/vis/artical/', $one['id'], "'"; ?>; return false;"><img style="opacity: 0.4;" src="<?php echo base_url(), 'images/eye.png'; ?>"
        <?php endif; ?>
         alt="#" /></a></span>

        <span class="vertical"><a title="видалити" href="javascript:void(0);" onclick="if (confirm('Видалити статтю?')) { window.location = <?php echo "'", base_url(), 'edit/del/artical/', $one['id'], "'"; ?>; } return false;"><img src="<?php echo base_url(); ?>images/del.png" alt="#" /></a></span>
      </div>
    </li>
...
<div class="right-sidebar" style="width: 500px; top: -20px;">
...
<li class="list-header"><div class="left"></div><?php echo preg_replace("/<[\/\!]*?[^<>]*?>/si", ' ', $one['name']); ?><div class="right"></div></li>
<li class="clear"></li>
<?php else : ?>
<li><a href="<?php echo base_url(), $MODULE, '/', $SUBMODULE, '/', $one['id']; ?>"><?php echo preg_replace("/<[\/\!]*?[^<>]*?>/si", ' ', $one['name']); ?></a></li>
<?php endif; ?>
<?php endforeach; ?>
</ul>
<?php endif; ?>
