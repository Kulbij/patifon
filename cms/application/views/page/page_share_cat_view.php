...
<div class="catalog-list">
  ...
  <div class="clear"></div>
    <div class="add"><img src="<?php echo base_url(); ?>images/plus.png" alt="#" /><a href="<?php echo base_url(), 'edit/page/'.$SUBMODULE; ?>">Додати категорію</a></div>
   ...
   <?php $i = 0; $count_bb = count($content['data']); foreach ($content['data'] as $one) : ?>
    ...
    <li class="item">
      ...
      <div class="right-item">
        ...
        <span class="vertical"><a title="подивитись на сайті" href="<?php echo getsite_url(), 'shares/', $one['link']; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/zoom.png" alt="#" /></a></span>
        <?php endif; ?>
