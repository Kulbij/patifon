  ...
  <ul>
   ...
   <?php $i = 0; $count_bb = count($content['data']); foreach ($content['data'] as $one) : ?>
    ...
    <li class="item">
      ...
      <div class="center-item"><span class="vertical"><a href="<?php echo base_url(), 'edit/page/', $SUBMODULE, '/', $one['id']; ?>"><?php echo mb_substr($one['question'], 0, 55); ?></a></span></div>


      <div class="right-item">
        <?php if ($one['visible'] == 1) : ?>
        <span class="vertical"><a title="подивитись на сайті" href="<?php echo getsite_url(), 'faq'; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/zoom.png" alt="#" /></a></span>
        <?php endif; ?>
...
<div class="right-sidebar" style="width: 500px;">
