...
<div class="creation_page">
  ...
  <h2>Повідомлення №<?php echo $content['id']; ?>&nbsp;
      ...
      <div style="width: 150px; display: inline-block;"><strong>Дата:</strong></div><div style="width: 70%; display: inline-block;"><?php echo date('d.m.Y H:i:s', strtotime($content['date'])); ?></div><br /></div>
      <div class="clear"></div><div class="field">
      <div style="width: 150px; display: inline-block;"><strong>E-mail:</strong></div><div style="width: 70%; display: inline-block;"><?php echo $content['email']; ?></div><br /></div>
      
      <?php if (isset($SDS)) : ?>
      <div class="clear"></div><div class="field">
      <div style="width: 150px; display: inline-block;"><strong>Тема:</strong></div><div style="width: 70%; display: inline-block;"><?php echo $content['theme']; ?></div><br /></div>
      <?php endif; ?>
      
      <div class="clear"></div><div class="field">
      <div style="width: 150px; display: inline-block; vertical-align: top;"><strong>Повідомлення:</strong></div><div style="width: 70%; display: inline-block;"><?php echo $content['text']; ?></div><br /></div>
      <div class="clear"></div>
      <br /><hr /><br />
      <div class="field">
