...
@session_start();
$tinybrowser['sessioncheck'] = 'id_admin_data'; //name of session variable to check

#if you enter in cms, session crushed :(
if (!isset($_SESSION['id_admin_data'])) die('Access denied!');
...
$tinybrowser['path']['image'] = '/files/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/files/uploads/media/'; // Media files location
$tinybrowser['path']['file'] = '/files/uploads/files/'; // Other files location
